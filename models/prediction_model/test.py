...
output = make_predictions(models_dict=fetched_models, data=fake_test_data_array)
print(output)

output_reduced = make_predictions(models_dict=fetched_models, data=fake_test_data_array,
