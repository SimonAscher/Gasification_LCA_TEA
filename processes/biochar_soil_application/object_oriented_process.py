...
from configs.requirement_objects import Requirements, BiogenicGWP
...
class BiocharSoilApplication(Process):
    ...
    def calculate_requirements(self, biochar_yield_predictions=None, carbon_fraction=None, stability=None):
        ...
        biochar_requirements.add_requirement(BiogenicGWP(values=list(GWP_labile),
                                                         name="Emissions due to labile fraction of biochar"))
        biochar_requirements.add_requirement(
            BiogenicGWP(values=list(GWP_recalcitrant),
                        name="Avoided emissions due to recalcitrant fraction of biochar",
                        biogenic_fraction=1 - settings.background.biogenic_carbon_equivalency))
