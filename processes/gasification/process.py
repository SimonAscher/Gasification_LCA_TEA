...
from configs.requirement_objects import Requirements, Electricity, Oxygen, Steam
...
class Gasification(Process):
    ...
    def calculate_requirements(self, agent_type=None, agent_mass=None, FU=settings.general["FU"],
        ...
        if agent_type == "Air" or agent_type == "Other":
            ...
            agent_requirements.add_requirement(Oxygen(values=list(to_MC_array(total_oxygen_mass)),
            ...
            agent_requirements.add_requirement(Steam(values=list(to_MC_array(total_steam_mass)),
        ...
        for _ in range(MC_iterations):
            electricity_auxiliary.append(demands_aux_gas_cleaning())
