...
summary_df = combine_GWP_dfs((df_1, df_2, df_3, df_4, df_5))

# Create plots
global_plot = plot_global_GWP(summary_df)
avg_plot = plot_average_GWP_byprocess(summary_df)
individual_plot = plot_single_process_GWP(summary_df, process_name="CHP")
# individual_plot2 = plot_single_process_GWP(summary_df, process_name="Gasification")
