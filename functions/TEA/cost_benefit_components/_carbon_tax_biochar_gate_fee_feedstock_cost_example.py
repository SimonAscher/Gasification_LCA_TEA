...
from functions.TEA.cost_benefit_components import carbon_price_cost_benefit, biochar_sale_cost_benefit, gate_fee_or_feedstock_cost_benefit
...
b = carbon_price_cost_benefit(results)
